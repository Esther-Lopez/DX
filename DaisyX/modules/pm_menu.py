...
async def get_start_func(message, strings, edit=False):
    ...
    buttons.add(
        ...
        InlineKeyboardButton(strings["btn_group"], url="https://t.me/onlinestroylovers"),
    )
    buttons.add(
        InlineKeyboardButton(
            "👸🏼 Add me to your group",
            url=f"https://telegram.me/kalippibot?startgroup=true",
        )
    )
...
async def help_cmd_g(message, strings):
    ...
    button = InlineKeyboardMarkup().add(
        InlineKeyboardButton(text=text, url="https://t.me/kalippiBOT?start")
    )
    await message.reply(strings["help_header"], reply_markup=button)
